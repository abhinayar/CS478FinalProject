...
var BasicScene = Class.extend({
    ...
    init: function() {
        ...
        var sphere = new THREE.SphereGeometry( 6, 16, 8 );
        this.light = new THREE.PointLight(0xffffff, 1, 0, 2);
        this.light.add( new THREE.Mesh( sphere, new THREE.MeshBasicMaterial( { color: 0xffffff } ) ) );
        this.light.position.set(0, 250, 0);
        this.scene.add(this.light);
      
        this.light2 = new THREE.PointLight( 0xff0000, 10, 1000, 2);
        this.light2.position.set(250, 200, 0 );
        this.light2.add( new THREE.Mesh( sphere, new THREE.MeshBasicMaterial( { color: 0xff0040 } ) ) );
        this.scene.add( this.light2 );
      
        this.light3 = new THREE.PointLight( 0xff0000, 10, 1000, 2);
        this.light3.position.set(-250, 200, 0 );
        this.light3.add( new THREE.Mesh( sphere, new THREE.MeshBasicMaterial( { color: 0xff0040 } ) ) );
    ...
    setFocus: function(object) {
        'use strict';
        this.camera.position.set(object.position.x, object.position.y + 20, object.position.z - 240);
